  ...
  /**
    ...
    */
    ...
    function __construct(){
      ...
      $this->Toenablethemesettings = __( 'To enable theme settings in Dashboard and Customizer you need the latest version of ZMPlugin. ZMPlugin is a free WordPress extension to manage theme options and customizer settings of ZuestMedia WordPress Themes.', 'zmt-modular' );
